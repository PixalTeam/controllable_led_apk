...
public final class HttpRequest {
    ...
    private static class SocketTimeOutRetryHandler implements HttpRequestRetryHandler {
        ...
        private SocketTimeOutRetryHandler(HttpParams httpParams2, int maxNrRetries2) {
            this.httpParams = httpParams2;
            this.maxNrRetries = maxNrRetries2;
        }
    ...
    public void setMaxNrRetries(int maxNrRetries2) {
        this.maxNrRetries = maxNrRetries2;
    }
